...
#pragma warning restore SKEXP0001 // Type is for evaluation purposes only and is subject to change or removal in future updates. Suppress this diagnostic to proceed.
    ...
    public async Task<Agent365AgentResponse> InvokeAgentAsync(string input, ChatHistory chatHistory, ITurnContext context)
    {
        ...
        // Extract tenant and agent IDs from context
        string? tenantId = context.Activity?.Recipient?.TenantId;
        string? agentId = context.Activity?.Recipient?.AgenticAppId;
        
        // Set baggage context for observability
        ...
        //{
            ...
            else
            {
                ...
                {
                    return await InvokeAgentAsync($"That response did not match the expected format. Please try again. Error: {je.Message}", chatHistory, context);
                }
            }
        //}
    }
