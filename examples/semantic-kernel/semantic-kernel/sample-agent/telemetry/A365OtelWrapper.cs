...
namespace Agent365SemanticKernelSampleAgent.telemetry
{
    public static class A365OtelWrapper
    {
        ...
        /// <returns></returns>
        private static Task<(string agentId, string tenantId)> ResolveTenantAndAgentId(ITurnContext turnContext, UserAuthorization authSystem, string authHandlerName)
        {
            string agentId = "";
            ...
            {
                // For non-agentic requests, we'll use a generated GUID
                // In production, you'd extract this from the auth token
            ...
            return Task.FromResult((agentId, tenantId));
        }
