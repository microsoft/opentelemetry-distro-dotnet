...
{
    /// <summary>
    /// Process-wide, monotonic record of features and instrumentations that have actually
    /// been used. Writers can run on telemetry and transport threads while the observable
    /// gauge reads the masks on the SDKStats collection thread.
    /// </summary>
